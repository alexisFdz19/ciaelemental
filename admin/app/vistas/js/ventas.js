			...
			var IDproyecto = respuesta['id_categoria'];  
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<input type="text" class="form-control nuevaDescripcionProducto" idProducto="'+idProducto+'" name="nuevaDescripcionProducto" value="'+descripcion+'" readonly required>'+
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
				  ...
				  '<input type="text" class="form-control agregarID" idProducto="'+idProducto+'" name="agregarID" value="'+IDproyecto+'"readonly required>'+
...
$(".formularioVenta").on("change", "select.nuevaDescripcionProducto", function(){
	...
	var agregarProyectoID = $(this).parent().parent().parent().children().children().children(".agregarID");
	  ...
	  $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
			...
			$(agregarProyecto).val(respuesta["nomProyec"]);
			$(agregarProyectoID).val(respuesta["id_categoria"]);
