...
class tareasController extends AppController{
	...
	public function index(){
		...
		$this->_view->titulo = "Administrador de ligas de interés";
	...
	public function Agregar(){
			...
			$tareas = $this->loadModel("tarea");
				...
				if ($tareas->guardar($_POST)){
					...
					$this->_messages->success(
						...
						'liga de interés guardada correctamente', 
		...
		$this->_view->titulo = "Agregar liga de interés";
	...
	public function editar($id=null){
		...
		if($_POST){
			...
			if($tarea->actualizar($_POST)){
				...
				$this->_messages->success(
					...
					'liga de interés editada correctamente', 
					$this->redirect(array("controller"=>"tareas"))
				...
				$this->_messages->error(
					...
					'Error al editar la liga de interés', 
					$this->redirect(array("controller"=>"tareas"))
		...
		$this->_view->titulo = "Editar liga de interés";
	...
	public function eliminar ($id){
		...
		if(!empty($registro)){
			...
			$this->_messages->success(
				...
				'liga de interés eliminada correctamente', 
				$this->redirect(array("controller"=>"tareas"))
